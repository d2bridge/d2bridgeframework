...
uses
  ...
  D2Bridge.Forms, FMX.Menus, FMX.Edit, FMX.Objects; //Declare D2Bridge.Forms always in the last unit
...
procedure TForm_Login.RenderD2Bridge(const PrismControl: TPrismControl;
