...
uses
  ...
  D2Bridge.Item.HTML.Card, D2Bridge.Item.HTML.Row,{ INHERITED, }D2Bridge.Forms;
...
procedure TForm_CrudTemplate.CrudDefaultSearch(ATable, AFieldWhere, ASearch, AFieldOrder: string);
begin
 CrudDefaultSearch(ATable, [AFieldWhere], ASearch, [], [], [AFieldOrder]);
end;

procedure TForm_CrudTemplate.CrudDefaultSearch(ATable: string; AWhereFields: array of string; ASearch: string);
begin
 CrudDefaultSearch(ATable, AWhereFields, ASearch, [], [], []);
end;

procedure TForm_CrudTemplate.CrudDefaultSearch(ATable: string; AWhereFields: array of string; ASearch: string; AAnd: TArray<string>);
begin
 CrudDefaultSearch(ATable, AWhereFields, ASearch, AAnd, [], []);
end;

procedure TForm_CrudTemplate.CrudDefaultSearch(ATable: string; AWhereFields: array of string; ASearch: string; AAnd, AOr: TArray<string>);
begin
 CrudDefaultSearch(ATable, AWhereFields, ASearch, AAnd, AOr, []);
end;

procedure TForm_CrudTemplate.CrudDefaultSearch(ATable: string; AWhereFields: array of string; ASearch: string; AAnd, AOr, AOrderFields: TArray<string>);
var
 I: integer;
...
procedure TForm_CrudTemplate.CrudOperation(ACrudOperation: TCrudOperation);
var
...
function TForm_CrudTemplate.CrudOperationPermission(ACrudOperation: TCrudOperation): boolean;
begin
 result:= true;
