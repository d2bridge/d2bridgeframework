...
begin
 ...
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort({Server_Port});
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('{Server_Name}');
