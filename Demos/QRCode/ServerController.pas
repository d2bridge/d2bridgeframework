...
Uses
 ...
 QRCode_Session, Data.DB, Datasnap.DBClient;
...
Function QRCode: TQRCodeSession;
...
Function QRCode: TQRCodeSession;
begin
 Result:= TQRCodeSession(D2BridgeInstance.PrismSession.Data);
end;
...
begin
 D2BridgeInstance.PrismSession.Data := TQRCodeSession.Create(Session);
