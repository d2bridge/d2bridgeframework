...
uses
  ...
  Data.Win.ADODB, D2Bridge.Forms, Vcl.Buttons, FireDAC.Stan.Intf,
...
begin
 ...
 begin
  active:= false;
  Params.ParamByName('AUTO_CODIGO_EQUIPAMENTO').Value:= DM.Equipamento.FieldByName('Auto_Codigo').Asinteger;
  active:= true;
 end;
