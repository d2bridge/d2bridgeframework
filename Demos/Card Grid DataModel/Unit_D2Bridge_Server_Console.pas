...
uses
  System.SysUtils, System.IniFiles, Winapi.Windows, System.DateUtils, Vcl.Controls;
...
begin
 D2BridgeServerController:= TCardGridDataModelWebAppGlobal.Create(Application);
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(8888);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('Card Grid DataModel Example');

 D2BridgeServerController.APPName:= 'CardGridDataModel';
