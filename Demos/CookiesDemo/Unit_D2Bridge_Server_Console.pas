...
begin
 D2BridgeServerController:= TCookiesDemoWebAppGlobal.Create(Application);
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(8888);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('D2Bridge Server Primary');
