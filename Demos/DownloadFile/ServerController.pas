...
Uses
 ...
 DownloadFile_Session, Data.DB, Datasnap.DBClient;
...
Function DownloadFile: TDownloadFileSession;
...
Function DownloadFile: TDownloadFileSession;
begin
 Result:= TDownloadFileSession(D2BridgeInstance.PrismSession.Data);
end;
...
begin
 D2BridgeInstance.PrismSession.Data := TDownloadFileSession.Create(Session);
