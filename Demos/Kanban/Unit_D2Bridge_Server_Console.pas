...
begin
 D2BridgeServerController:= TKanbanWebAppGlobal.Create(Application);
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(8888);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('Kanban Example');

 D2BridgeServerController.APPName:= 'Kanban';
