...
begin
 D2BridgeServerController:= TDemoAmazonS3WebAppGlobal.Create(Application);
 vServerPort:= D2BridgeServerController.Prism.INIConfig.ServerPort(8888);
 vServerName:= D2BridgeServerController.Prism.INIConfig.ServerName('Demo AmazonS3');

 D2BridgeServerController.APPName:= 'DemoAmazonS3';
