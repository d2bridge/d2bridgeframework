...
uses
  Classes, SysUtils, IniFiles, Controls, Forms,
...
begin
 D2BridgeServerController:= TMarkDownEditorWebAppGlobal.Create(Application);
 ...
 D2BridgeServerController.APPName:= 'MarkDownEditor';
