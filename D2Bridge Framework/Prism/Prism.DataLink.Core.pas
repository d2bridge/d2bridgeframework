 ...
 try
  ...
  begin
   ...
   begin
    ...
    begin
     try
      vBookMarkValid:= false;
      if DataSet.Eof then
       vBookMarkValid:= false
      else
       vBookMarkValid:= DataSet.BookmarkValid(FPreviousBookmark);
     except
      vBookMarkValid:= false;
      DataSet.FreeBookmark(FPreviousBookmark);
     end;

     if vBookMarkValid then
     begin
      FCanceled:= true;
     end else
      begin
